...
class Game:
    ...
    def __init__(self , root1, username_lg="" ):
        ...
        if userName != "":
            ...
            self.le5 = Label ( self.frame1 , text = "No User is Signed!" , bg = '#212122' , fg = "white" , border = 0 ,
                               font = ("Century" , 12) )
            self.le5.place ( x = 1368 , y = 100 )
        ...
        # -----------------------------------------------------------------------------------------------
                ...
                self.entry2 = Label ( self.frame1 , text = f"{username[0]}" , fg = 'white' ,
                                      bg = "#212122" ,
                                      border = 0 , font = ('Century' , 16 , 'bold') )
                self.entry2.place ( x = 910 , y = 80 )
                self.entry2 = Label ( self.frame1 , text = f"{username[1]}" ,
                                      fg = 'white' , bg = "#212122" ,
                                      border = 0 , font = ('Century' , 16 , 'bold') )
                self.entry2.place ( x = 904 , y = 127 )
