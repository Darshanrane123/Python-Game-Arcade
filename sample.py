...
class Game:
    ...
    def __init__(self , root1, username_lg="" ):
        ...
        self.img13 = PhotoImage ( file = "images/space invader3.png" )
        ...
        def mario():
            ...
            self.b4 = Label ( self.frame1 , image = self.img3 , bg = 'white' , border = 2 )
        ...
        def shooter():
            ...
            self.b4 = Label ( self.frame1 , image = self.img5 , bg = 'white' , border = 2 )
            self.b4.place ( x = 70 , y = 70 )
            self.b6 = Button ( self.frame1 , image = self.img4 , bg = 'white' , border = 0 , command = play ,
                               cursor = 'hand2' )
            self.b6.place ( x = 300 , y = 500 )
        ...
        def flappy():
            ...
            self.b4 = Label ( self.frame1 , image = self.img10 , bg = 'white' , border = 2 )
            self.b4.place ( x = 70 , y = 70 )
            self.b6 = Button ( self.frame1 , image = self.img4 , bg = 'white' , border = 0 , command = play ,
                               cursor = 'hand2' )
            self.b6.place ( x = 300 , y = 500 )
        ...
        def spaceInavder():
            ...
            self.b4 = Label ( self.frame1 , image = self.img14 , bg = 'white' , border = 2 )
            self.b4.place ( x = 70 , y = 70 )
            self.b6 = Button ( self.frame1 , image = self.img4 , bg = 'white' , border = 0 , command = play ,
                               cursor = 'hand2' )
            self.b6.place ( x = 300 , y = 500 )
        ...
        #         self.L1 = Label(self.frame1, image = self.img_tk,bg='#212122', border=0 )
        ...
        #         self.ima = cv2.imread("C:/Users/sujal/PycharmProjects/new_Python_Project/images/bgimg.png" )
        #         self.imgr1 = cv2.resize ( self.ima , (160 , 90) )
        #         self.img_rgb1 = cv2.cvtColor ( self.imgr1 , cv2.COLOR_BGR2RGB )
        #         self.img_tk = ImageTk.PhotoImage ( Image.fromarray ( self.img_rgb1 ) )
        #         self.L1 = Label(self.frame1, image = self.img_tk,bg='#212122', border=0 )
        ...
        def profile():
            ...
            if userName == "":
                ...
                self.entry2 = Label ( self.frame1 , text = "No User Is Signed" , width = 12 , fg = 'white' ,
                                      bg = "#212122" , border = 0 , font = ('Century' , 16 , 'bold') )
                self.entry2.place ( x = 675 , y = 300 )
        ...
        if username_lg != "":
            self.bt2 = customtkinter.CTkButton ( self.frame , width = 36 , text = 'Logout' , bg_color = 'white' ,
                                                border_spacing = 10 , font = ('Futura' , 20 ,
                                                                              'bold') , command = logout )
            self.bt2.place ( x = 1100 , y = 34 )
