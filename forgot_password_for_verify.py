            ...
            if self.flag :
                ...
                try:
                    ...
                    self.msg = ('Welcome to Exsto  Gaming ! \n'
                               'Use this Verification Code Below to Login. \n'
                               ' \n \t'+ str(self.generate_otp)+
                               '\n\n'
                               'You Have Received this email because\n'
                               'you have requested to Login to Exsto Gaming\n'
                               'if you did not request to Login kindly Ignore this \n'
                               'Email.\n'
                               '- Team Exsto Gaming ' )
